...
namespace GLOO {
    ...
    public:
        ...
        SceneNode &GetChild(size_t index) const { return *children_.at(index); }

        SceneNode *GetParentPtr() const { return parent_; }
        ...
        void SetActive(bool new_state) { active_ = new_state; }
    ...
    private:
        ...
        std::unordered_map<ComponentType, std::unique_ptr<ComponentBase>, EnumClassHash> component_dict_;
