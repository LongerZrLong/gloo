...
#include "gloo/gl_wrapper/VertexArray.h"
...
// for sending data from CPU to GPU via the Update* methods.
    ...
    public:
        ...
        bool HasPositions() const { return positions_ != nullptr; }

        bool HasNormals() const { return normals_ != nullptr; }

        bool HasColors() const { return colors_ != nullptr; }

        bool HasTexCoors() const { return tex_coords_ != nullptr; }

        bool HasIndices() const { return indices_ != nullptr; }
