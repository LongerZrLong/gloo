...
#include "gloo/gl_wrapper/IBindable.h"
...
namespace GLOO {
    ...
    public:
        ...
        virtual void SetTargetNode(const SceneNode &node, const glm::mat4 &local_to_world_mat) const {}
    ...
    private:
        static GLuint LoadShader(GLenum type, std::string shader_code, const std::string &shader_filename);
